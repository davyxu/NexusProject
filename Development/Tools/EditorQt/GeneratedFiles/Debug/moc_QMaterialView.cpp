/****************************************************************************
** Meta object code from reading C++ file 'QMaterialView.h'
**
** Created: Thu Oct 6 23:41:56 2011
...
#error "The header file 'QMaterialView.h' doesn't include <QObject>."
...
static const uint qt_meta_data_QMaterialView[] = {
...
static const char qt_meta_stringdata_QMaterialView[] = {
    "QMaterialView\0"
};

const QMetaObject QMaterialView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QMaterialView,
      qt_meta_data_QMaterialView, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QMaterialView::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *QMaterialView::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *QMaterialView::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QMaterialView))
        return static_cast<void*>(const_cast< QMaterialView*>(this));
    return QWidget::qt_metacast(_clname);
}

int QMaterialView::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
